...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
    ...
    <td width="65%" valign="middle" style="padding: 20px 40px;">
      <div align="left">
        <h1 style="margin: 0; font-size: 2.5em; background: linear-gradient(135deg, #cba6f7 0%, #89b4fa 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;">
          Ransara Devnath
        </h1>
        <p style="font-size: 1.2em; color: #94a3b8; margin: 10px 0; font-weight: 500;">
...
<a href="https://ransara-devnath.vercel.app/" target="_blank">
  <img src="https://img.shields.io/badge/🌐_Portfolio-89b4fa?style=for-the-badge&logo=vercel&logoColor=white&labelColor=0f172a" alt="Portfolio"/>
</a>
&nbsp;
<a href="https://ransgpt-v3-ai.netlify.app/" target="_blank">
  <img src="https://img.shields.io/badge/🤖_RansGPT_AI-cba6f7?style=for-the-badge&logo=openai&logoColor=white&labelColor=0f172a" alt="RansGPT"/>
</a>
&nbsp;
  ...
  <tr>
    ...
    <td width="50%" style="background: linear-gradient(135deg, #1e1b4b 0%, #2d1b4e 100%); border: 2px solid #581c87; border-radius: 16px; padding: 25px; box-shadow: 0 8px 32px rgba(203, 166, 247, 0.15); transition: all 0.3s ease;">
      ...
      <p style="color: #cbd5e1; line-height: 1.8; margin-bottom: 0;">
        ...
        <strong>Backend Power:</strong> Node.js, Express<br/>
        <strong>AI Integration:</strong> OpenAI APIs, ML Models
      </p>
    </td>
  </tr>
</table>
...
<div style="background: linear-gradient(135deg, #1e1b4b 0%, #2d1b4e 100%); border: 2px solid #581c87; border-radius: 16px; padding: 30px; box-shadow: 0 8px 32px rgba(203, 166, 247, 0.15); transition: all 0.3s ease; hover: transform 0.3s ease;">
  ...
  <p style="color: #cbd5e1; font-size: 0.95em; line-height: 1.6; min-height: 60px; margin: 15px 0;">
    Advanced AI-powered chatbot with real-time responsiveness, custom modules, and seamless OpenAI integration.
  </p>
  <div style="margin: 15px 0;">
    ...
    <span style="display: inline-block; background: linear-gradient(135deg, #581c87, #7c3aed); color: white; padding: 6px 12px; border-radius: 6px; font-size: 0.85em; margin-right: 8px; margin-bottom: 8px;">OpenAI API</span>
  </div>
  <a href="https://ransgpt-v3-ai.netlify.app/" target="_blank" style="color: #89b4fa; text-decoration: none; font-weight: bold; font-size: 1em; transition: color 0.3s ease;">
    Explore →
  </a>
</div>
...
<div style="background: linear-gradient(135deg, #1e1b4b 0%, #2d1b4e 100%); border: 2px solid #581c87; border-radius: 16px; padding: 30px; box-shadow: 0 8px 32px rgba(203, 166, 247, 0.15); transition: all 0.3s ease;">
  <div style="font-size: 2.5em; margin-bottom: 15px;">🌐</div>
  <h3 style="margin-top: 0; color: #cba6f7; font-size: 1.4em;">Portfolio</h3>
  <p style="color: #cbd5e1; font-size: 0.95em; line-height: 1.6; min-height: 60px; margin: 15px 0;">
...
<p style="font-size: 1.1em; color: #cbd5e1; margin-bottom: 20px;">
  Always open to collaborate on exciting projects and discuss innovative ideas! 🚀
</p>
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://capsule-render.vercel.app/api?type=rounded&color=gradient&customColorList=cba6f7,89b4fa,581c87&height=100&section=footer&animation=fadeIn">
  <img alt="Footer" src="https://capsule-render.vercel.app/api?type=rounded&color=gradient&customColorList=cba6f7,89b4fa,581c87&height=100&section=footer&animation=fadeIn" width="100%">
</picture>

<p style="color: #94a3b8; font-family: 'Courier New', monospace; font-size: 0.9em; margin-top: 20px; margin-bottom: 10px;">
  <b>© 2026 Ransara Devnath</b>
</p>

<p style="color: #64748b; font-family: 'Courier New', monospace; font-size: 0.85em; margin: 5px 0;">
  Crafted with 💜 passion • Designed for 🚀 impact • Built with ⚡ precision
</p>

<p style="color: #475569; font-family: 'Courier New', monospace; font-size: 0.8em; font-style: italic;">
